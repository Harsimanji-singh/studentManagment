...
def main():
    def addstudent():
        def submitadd():
            ...
            try:
                ...
                messagebox.showerror('Notification','id already exist try new id',parent = addroot)
    ...
    def updatetudent():
        def update():
            ...
            con.commit()
            messagebox.showinfo('Notificcation', 'id {} modified succesfully'.format(id), parent=updateroot)
            strr = 'select * from studentdata1 '
            mycursor.execute(strr)
            datas = mycursor.fetchall()
            studenttable.delete(*studenttable.get_children())
    ...
    def connectdb():
        ...
        def submitdb():
            ...
            try:
                ...
                return
            try:
                strr = 'create database studentmanagmentsystem1'
                mycursor.execute(strr)
                strr = 'use studentmanagmentsystem1'
                mycursor.execute(strr)
                strr = 'create table studentdata1(id int,name varchar(30),mobile varchar(12),email  varchar(35),address varchar(100),gender varchar(50),dob varchar(40),Date varchar(50),time  varchar(50))'
                mycursor.execute(strr)
        ...
        #--------------------------------------------connectdb button
        submitbutton = Button(dbroot, text = 'Submit', font = ('roman',15,'bold'),bg = 'red',bd = 5,width = 20, activebackground = 'green',activeforeground = 'white',command = submitdb)
    ...
    '''#def introLableTick():
        ...
        if(count>=len(ss)):
            ...
            SliderLabel.config(text=text)
            count+=1
        SliderLabel.after(200,introLableTick)'''
    ...
    #----------------------------frames intro
    frontlabel = Label(DataEntryFrame,text = '-------------------welcome-------------------',width = 30,font= ('ariel',20,'bold'),bg = 'gold2')
    frontlabel.pack(side = TOP,expand= True)
    addbutton = Button(DataEntryFrame,text='1: Add students',width = 25,font = ('chiller',20,'bold'),bd = 6,bg = 'skyblue3',activebackground = 'blue',relief = RIDGE,activeforeground = 'white',command = addstudent)
    addbutton.pack(side = TOP,expand = True)

    serchbutton = Button(DataEntryFrame,text='2: Serch students',width = 25,font = ('chiller',20,'bold'),bd = 6,bg = 'skyblue3',activebackground = 'blue',relief = RIDGE,activeforeground = 'white',command = serchstudent)
    serchbutton.pack(side = TOP,expand = True)

    deletebutton = Button(DataEntryFrame,text='3: Delete students',width = 25,font = ('chiller',20,'bold'),bd = 6,bg = 'skyblue3',activebackground = 'blue',relief = RIDGE,activeforeground = 'white',command = deletestudent)
    deletebutton.pack(side = TOP,expand = True)

    updatebutton = Button(DataEntryFrame,text='4: update students',width = 25,font = ('chiller',20,'bold'),bd = 6,bg='skyblue3', activebackground='blue',relief = RIDGE,activeforeground = 'white',command = updatetudent)
    updatebutton.pack(side = TOP,expand = True)

    showbutton = Button(DataEntryFrame, text='5: Show All', width=25, font=('chiller', 20, 'bold'), bd=6, bg='skyblue3', activebackground='blue', relief = RIDGE,activeforeground = 'white',command = showsstudent)
    showbutton.pack(side=TOP, expand=True)

    Exportbutton = Button(DataEntryFrame, text='6: Export Data', width=25, font=('chiller', 20, 'bold'), bd=6, bg='skyblue3', activebackground = 'blue',relief=RIDGE, activeforeground = 'white', command = exportstudent)
    Exportbutton.pack(side=TOP, expand=True)

    Exitbutton = Button(DataEntryFrame, text='7: Exit', width=25, font=('chiller', 20, 'bold'), bd=6, bg='skyblue3', activebackground='blue', relief=RIDGE, activeforeground='white', command=exitstudent)
    ...
    studenttable = Treeview(ShowDataFrame, column=('id', 'Name', 'mobile', 'Email', 'address', 'gender', 'D.O.B', 'Added Date', 'Added time'),
    ...
    #################################################################################### Slider
    ss = 'Welcome to student managment sysytm'
    count = 0
    text = ''
    ######################################################################
    ...
    tick()
    ##########################################
    connectbutthon = Button(root, text='Connect to Database', width=23, font=('chiller', 19, 'italic bold'), relief=RIDGE, borderwidth=4, bg='green2',
                            activebackground='blue', activeforeground='white', command=connectdb)
    connectbutthon.place(x=930, y=0)
    root.mainloop()
from tkinter import *
mainroot  = Tk()
...
conButton = Button(mainroot, text='Login ', width=10, font=('oracle', 19, 'bold'), relief=GROOVE, bg = 'green', activebackground='firebrick1',activeforeground='royal blue',command = main)
